...
var model_ready_list = [false, false, false, false, false, false]
...
function start() {
    ...
    cube = new THREE.Mesh(new THREE.CylinderGeometry(1, 1, 2, 30), new THREE.MeshBasicMaterial({ color: 0x00ff00, opacity: 0.5, transparent: true }));
    cube.name = "statue1"
    objs_test.push(cube)
    scene.add(cube);
    //cube.visible = false
    ...
    cube1 = new THREE.Mesh(new THREE.CylinderGeometry(1, 1, 2, 30), new THREE.MeshBasicMaterial({ color: 0x00ff00, opacity: 0.5, transparent: true }));
    cube1.name = "statue2"
    ...
    cube4 = new THREE.Mesh(new THREE.CylinderGeometry(1, 1, 3, 30), new THREE.MeshBasicMaterial({ color: 0x00ff00, opacity: 0.5, transparent: true }));
    cube4.name = "statue3"
    objs_test.push(cube4)
    scene.add(cube4);
    cube4.visible = false

    cube5 = new THREE.Mesh(new THREE.CylinderGeometry(1, 1, 3, 30), new THREE.MeshBasicMaterial({ color: 0x00ff00, opacity: 0.5, transparent: true }));
    cube5.name = "statue4"
    ...
    var part1 = new THREE.Mesh(new THREE.BoxGeometry(1, 0.24, 1), new THREE.MeshBasicMaterial({ color: 0x00ff00 }));
    part1.rotation.y = Math.PI / 4

    part1.name = "statue_arrow"

    var part2 = new THREE.Mesh(new THREE.BoxGeometry(1, 1, 1), new THREE.MeshBasicMaterial({ color: 0x00ff00 }));
    ...
    for (let i = 0; i < intersects.length; i++) {
        ...
        if (intersects[i].object.name.includes("statue")) {
            ...
            if (intersects[i].object.name === "statue1") {
                ui.visible = true
                if (bg_status === 2) {
                    title.set({ content: "STATUE Dl SAN VINCENZO DE PAOLI E SAN GIOVANNI EUDES" })
                    text.set({
                    ...
                    title.set({ content: "MONUMENTO A SANT'IGNAZIO" })
                    text.set({
                ...
                if (bg_status === 2) {
                    title.set({ content: "STATUE Dl SAN CAMILLO DE LELLIS E SAN LUIGI MARIA GRIGNON DE MONTFORT" })
                    text.set({
                    ...
                    title.set({ content: "STATUE Dl SAN FILIPPO NERI E SAN GIOVANNI BATTISTA DE LA SALLE" })
                    text.set({
                ...
                title.set({ content: "STATUA Dl SAN GIOVANNI BOSCO" })
                text.set({
